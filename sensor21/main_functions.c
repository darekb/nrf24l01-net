...
//sypialnia in
#if SENSOR_ID == 71
char startStringSensor[] = {'s', 't', 'a', 'r', 't', '-', 's', '7', '1'};
char resetStringSensor[] = {'r', 'e', 's', 'e', 't', '-', 's', '7', '1'};
#endif

//salon out
#if SENSOR_ID == 22
char startStringSensor[] = {'s', 't', 'a', 'r', 't', '-', 's', '2', '2'};
char resetStringSensor[] = {'r', 'e', 's', 'e', 't', '-', 's', '2', '2'};
#endif
//salon in
#if SENSOR_ID == 72
char startStringSensor[] = {'s', 't', 'a', 'r', 't', '-', 's', '7', '2'};
char resetStringSensor[] = {'r', 'e', 's', 'e', 't', '-', 's', '7', '2'};
#endif

//dzieciecy
#if SENSOR_ID == 73
char startStringSensor[] = {'s', 't', 'a', 'r', 't', '-', 's', '7', '3'};
char resetStringSensor[] = {'r', 'e', 's', 'e', 't', '-', 's', '7', '3'};
#endif
