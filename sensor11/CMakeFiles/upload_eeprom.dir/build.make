...
CMakeFiles/upload_eeprom: atmega8.eep
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/dariusz/Arduino/nrf24l01-net/sensor11/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Uploading atmega8.eep to atmega8 using arduino"
	avrdude -p atmega8 -c arduino -b57600 -U eeprom:w:/home/dariusz/Arduino/nrf24l01-net/sensor11/bin/atmega8.eep -P /dev/ttyUSB1

atmega8.eep: bin/atmega8.elf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/dariusz/Arduino/nrf24l01-net/sensor11/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Generating atmega8.eep"
	/usr/bin/avr-objcopy -j .eeprom --set-section-flags=.eeprom=alloc,load --change-section-lma .eeprom=0 --no-change-warnings -O ihex /home/dariusz/Arduino/nrf24l01-net/sensor11/bin/atmega8.elf /home/dariusz/Arduino/nrf24l01-net/sensor11/bin/atmega8.eep
