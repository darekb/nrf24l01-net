...
fs.readFile('log-25-03-2017-test02-server.dat','utf8',function (err,data) {
  if (err) {
  ...
  lines.map(function (line){
    ...
    //   console.log(line);
      if(actTime > 0  && elems[3] && elems[3].trim() == 'got data from server' && elems[2]){
